...
describe('when there is initially one user in db', () => {
  ...
  test('creatiun suceeds with a fresh username', async () => {
    const usersAtStarts = await helper.userInDb()
  ...
  test('creation faild with proper statuscode and message if username alredy taken', async () => {
